...
const TECH_DATA = [
  ...
  { id: 'tc_speed1',   name: 'Hydraulic Boost',             icon: 'tc_speed1',   cost: 1,  req: null,        tierUnlock: 0, desc: '1.5× all worker output.', effect: () => { globalMult *= 1.5; } },
  { id: 'tc_click1',   name: 'Grip Gloves',                 icon: 'tc_click1',   cost: 2,  req: 'tc_speed1',   tierUnlock: 0, desc: '2× click power.',       effect: () => { clickMult *= 2; } },
  { id: 'tc_deep',     name: 'Depth Mapping',               icon: 'tc_deep',     cost: 3,  req: 'tc_click1',   tierUnlock: 0, desc: '2× all worker output.', effect: () => { globalMult *= 2; } },
  { id: 'tc_offline',  name: 'Night Shift',                 icon: 'tc_offline',  cost: 3,  req: null,        tierUnlock: 0, desc: '2× offline earnings.',  effect: () => { offlineMult *= 2; } },
  { id: 'tc_auto',     name: 'Smart Dispatch',              icon: 'tc_auto',     cost: 5,  req: 'tc_deep',     tierUnlock: 0, desc: '1.5× all worker output.', effect: () => { globalMult *= 1.5; } },
  { id: 'tc_prestige', name: 'Shard Resonance',             icon: 'tc_prestige', cost: 6,  req: 'tc_auto',     tierUnlock: 0, desc: '1.25× shard gain on ascension.', effect: () => { shardBonus *= 1.25; } },
  { id: 'tc_aria',     name: 'Project ARIA',                icon: 'tc_aria',     cost: 8,  req: 'tc_prestige', tierUnlock: 1, desc: 'Unlocks motivated workers. 2× all output.', effect: () => { globalMult *= 2; } },
  { id: 'tc_grimoire', name: 'Heretical Excavation Manual', icon: 'tc_grimoire', cost: 28, req: 'tc_aria',     tierUnlock: 2, desc: 'Unlocks what is below. 3× all output.', effect: () => { globalMult *= 3; } },
  { id: 'tc_quantum',  name: 'Quantum Lattice',             icon: 'tc_quantum',  cost: 12, req: 'tc_aria',     tierUnlock: 0, desc: '2× all worker output.', effect: () => { globalMult *= 2; } },
  { id: 'tc_geometry', name: 'Forbidden Geometry',          icon: 'tc_geometry', cost: 20, req: 'tc_grimoire', tierUnlock: 0, desc: '3× all worker output.', effect: () => { globalMult *= 3; } },
  { id: 'tc_dreaming', name: 'The Dreaming Engine',         icon: 'tc_dreaming', cost: 30, req: 'tc_geometry', tierUnlock: 0, desc: '5× click + 2× all workers.', effect: () => { clickMult *= 5; globalMult *= 2; } },
  { id: 'tc_singularity', name: 'Singularity Directive',    icon: 'tc_singularity', cost: 55, req: 'tc_dreaming', tierUnlock: 3, desc: 'Unlocks tier 3 upgrades. 4× all worker output.', effect: () => { globalMult *= 4; } },
];
